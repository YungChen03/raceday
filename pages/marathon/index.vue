  ...
  <div class="lime lighten-5">
    <v-container class="my-3 pa-5">
      <v-layout row class="ml-2" align-start>
        <img src="../../assets/img/run.svg" class="mx-1" />
        <img src="../../assets/img/race-track02.svg" class="mx-1" />
        <img src="../../assets/img/exercise.svg" class="mx-1" />
        <img src="../../assets/img/water-bottle.svg" class="mx-1" />
        <img src="../../assets/img/finish-line.svg" />

        <!-- <v-btn text mr-5 color="grey darken-2" @click="sortByDate">
...
export default {
  ...
  mounted() {
    const load = async () => {
      try {
        let res = await this.$getdocs.getData("marathon");
        this.events = res;
      } catch (err) {
